...
while rospy.Time.now().to_sec()-start_ejecution<29.99 and not rospy.is_shutdown():
...
while rospy.Time.now().to_sec()-start_ejecution2<45.6 and not rospy.is_shutdown():
